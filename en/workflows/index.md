...
- [7) Presentations and website](#presentations-and-website)
    ...
    - [Nikola](#nikola)
- [8) Automating a curriculum vitae](#automating-a-curriculum-vitae)
...
Certain citation styles also require you to include the date of access for digital resources. Due to [a long-standing bug](https://github.com/zotero/zotero/pull/813), Zotero will only include this if you enable the “Include URLs of paper articles in references” option in the Preferences -> Cite dialog. If you use Better BibTeX, you’ll want to enable it there as well: it’s in Preferences -> Better BibTeX -> Export -> Add URLs to BibTeX export; there’s an equivalent option in the “Automatic export” tab.
